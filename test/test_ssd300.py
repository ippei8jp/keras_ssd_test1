#!/usr/bin/env python
# coding: utf-8
# オリジナルソース：ssd300_inference.ipynbをpythonにexportしたソース
# SSD300 VOCで学習済みモデル用チュートリアル
...
# モデルファイルのパス
MODEL_PATH = "./VGG_VOC0712_SSD_300x300_iter_120000_with_model.h5"
WEIGHTS_PATH = '../weights/VGG_VOC0712_SSD_300x300_iter_120000.h5'      # h5ファイルのpath

# 保存するSavedModelのディレクトリ
SAVED_MODEL_DIR = "saved_model_ssd300"
